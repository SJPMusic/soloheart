...
from narrative_core.enhanced_memory_system import LayeredMemorySystem, MemoryType, MemoryLayer, EmotionalContext
from narrative_core.enhanced_ai_dm_engine import EnhancedAIDMEngine
...
def demo_memory_system():
    ...
    memory_system = LayeredMemorySystem(campaign_id="demo_campaign")
...
def demo_memory_persistence():
    ...
    memory_system = LayeredMemorySystem(campaign_id="persistence_demo")
