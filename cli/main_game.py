#!/usr/bin/env python3
"""
Main Game Launcher for Solo 5E-Compatible Adventure

This is the main entry point for the solo adventure game engine.
...
def handle_demo_quest_journal(campaign_manager: CampaignManager):
    ...
    try:
        ...
        from cli.demo_quest_journal import main as run_demo
        run_demo()
    except ImportError:
        print("❌ Quest journal demo not found.")
        print("   Make sure demo_quest_journal.py exists in the cli directory.")
    except Exception as e:
    ...
    while True:
        try:
            ...
            if choice == "1":
                ...
                print("\n👋 Thanks for playing Solo Adventure!")
