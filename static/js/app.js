// DnD 5E AI-Powered Game - Frontend JavaScript
// ===========================================
...
class DnDGameApp {
    ...
    bindEvents() {
        ...
        document.getElementById('new-campaign-modal').addEventListener('click', (e) => {
            if (e.target.id === 'new-campaign-modal') {
                this.hideModal();
            }
        });
    ...
    showNewCampaignModal() {
        document.getElementById('new-campaign-modal').classList.add('show');
        document.getElementById('campaign-name').focus();
    }

    hideModal() {
        document.getElementById('new-campaign-modal').classList.remove('show');
        this.focusInput();
    }
