#!/usr/bin/env python3
"""
LLM-Powered Character Generator for Solo DnD 5E
...
Important: Only use races, classes, and backgrounds from the SRD. If the player mentions something not in the SRD, suggest the closest SRD equivalent."""
    ...
    def _get_llm_response(self, system_prompt: str) -> str:
        ...
        if not self.client:
            return "I'm sorry, but the AI system is currently unavailable. Please try the step-by-step character creation instead."
        ...
        try:
            ...
            return "I'm having trouble processing that right now. Could you try rephrasing your response?"
